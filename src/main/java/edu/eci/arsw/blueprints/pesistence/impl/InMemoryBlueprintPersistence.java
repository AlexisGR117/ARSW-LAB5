...
public class InMemoryBlueprintPersistence implements BlueprintsPersistence {
    ...
    public InMemoryBlueprintPersistence() {
        ...
        Point[] pts2 = new Point[]{new Point(40, 10), new Point(55, 75), new Point(35, 120), new Point(5, 82)};
        Blueprint bp2 = new Blueprint("Jon", "The paint", pts2);
        blueprints.put(new Tuple<>(bp2.getAuthor(), bp2.getName()), bp2);
        Point[] pts3 = new Point[]{new Point(90, 20)};
